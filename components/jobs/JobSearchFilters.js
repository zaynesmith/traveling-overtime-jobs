...
export default function JobSearchFilters({ filters, onChange, onSubmit, onReset, className = "" }) {
  return (
    <form onSubmit={onSubmit} className={`${filterPanelClasses} grid gap-4 md:grid-cols-6 md:gap-6 ${className}`}>
      ...
      <div className="md:col-span-6 flex flex-col gap-3 sm:flex-row sm:items-end">
        <button
          type="submit"
