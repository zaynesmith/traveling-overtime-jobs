        ...
        <main style={wrap}>
          ...
          <section style={grid}>
            <div style={card}>
              ...
              <p>Find jobs and manage your applications.</p>
              <div style={row}>
...
const pillDark = { display:"inline-block", background:"#111", color:"#fff", borderRadius:999, padding:"10px 14px", fontWeight:700, textDecoration:"none" };
const pillLight = { display:"inline-block", background:"#fff", color:"#111", border:"1px solid #ddd", borderRadius:999, padding:"10px 14px", fontWeight:700, textDecoration:"none" };
